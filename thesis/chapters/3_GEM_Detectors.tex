...
\begin{itemize}
    ...
    \item As the gain depends on the diameter of the hole and the thickness of foil~\todo[inline]{cite reference for gain vs hole size}. So, it will help us to understand the performance of GEM foil such as gain, etc at a later stage.
\end{itemize}
