...
While designing a HEP detector we need to take into account the environment created by the two proton-proton collision at LHC. Following things we need to take into account:

\begin{itemize}
	\item \textbf{Delivered Luminosity from LHC} THis tis.
	\item \textbf{Produced ratiation} this
	\item \textbf{pile up}. this
	\item \textbf{Event rate}thsil
\end{itemize}
...
CMS detector is shown in Figure~\ref{fig:CMS-detector}.

\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.95\textwidth]{figures/LHC/cms_complete_labelled.pdf}
