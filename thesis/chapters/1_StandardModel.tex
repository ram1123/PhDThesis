...
In terms of the physical fields, there are two types of triple gauge couplings - $\gamma \ww$ and $Z \ww$ - and three types of quartic gauge couplings, $\ww \ww$, $\ww ZZ$, $\ww Z \gamma$ and $\ww \gamma \gamma$, which are allowed in the SM.
