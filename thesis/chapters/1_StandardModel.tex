...
However, the SM still leaves some unexplained phenomena, such as 
\begin{itemize}
...
\end{itemize}
% \begin{enumerate}
%     \item What is the reason behind spontaneous symmetry breaking?
%     \item Is the Higgs boson only source for preserving the unitrization in vector-boson scattering? 
%     \item Why there is baryon asymmetry in Universe? and many more.
% \end{enumerate}
